...
function ToggleButtonProbe() {
  ...
  return (
    <button
      ...
      type="button"
    >
      <i data-testid="theme-icon" className={theme === 'dark' ? 'fas fa-sun' : 'fas fa-moon'} />
    </button>
  );
}
