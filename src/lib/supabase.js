...
function getSupabase() {
  ...
  if (!supabaseUrl || !supabaseAnonKey) {
    console.warn('[supabase.js] Supabase anon key not configured. Auth and realtime will not work.')
    return null
  }
  ...
  if (typeof localStorage !== 'undefined' && localStorage.getItem(SIGNED_OUT_KEY)) {
