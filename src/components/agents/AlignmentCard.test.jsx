...
describe('AlignmentCard', () => {
  it('renders alignment text with pre-wrap formatting', () => {
    const { container } = render(
      <AlignmentCard alignmentText={sampleText} onApprove={() => {}} onRevise={() => {}} />
    )
  ...
  it('calls onApprove when approve button is clicked', () => {
    ...
    render(
      <AlignmentCard alignmentText={sampleText} onApprove={onApprove} onRevise={() => {}} />
    )
  ...
  it('does not show feedback input initially', () => {
    ...
    expect(screen.queryByLabelText(/revision feedback/i)).not.toBeInTheDocument()
  })
  ...
  it('calls onRevise with feedback text when feedback is submitted', () => {
    ...
    render(
      <AlignmentCard alignmentText={sampleText} onApprove={() => {}} onRevise={onRevise} />
    )
    fireEvent.click(screen.getByRole('button', { name: /revise plan/i }))
    const textarea = screen.getByLabelText(/revision feedback/i)
    fireEvent.change(textarea, { target: { value: 'Add a security review step' } })
  ...
  it('renders with empty alignment text', () => {
    render(
      <AlignmentCard alignmentText="" onApprove={() => {}} onRevise={() => {}} />
    )
    const pre = screen.getByRole('region', { name: /alignment check/i }).querySelector('pre')
    expect(pre).toBeInTheDocument()
