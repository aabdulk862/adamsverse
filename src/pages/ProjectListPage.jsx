    ...
    <div className="project-list-page">
      ...
      {loading ? (
        ...
        <div className="project-list-empty">
          ...
          <p>Ready to get started? Pick a service tier and we'll take it from there.</p>
        ...
        <div className="project-list-table">
          <div className="project-list-table-header">
            <span className="project-list-col project-list-col--name">Name</span>
            <span className="project-list-col project-list-col--status">Status</span>
            <span className="project-list-col project-list-col--tier">Service Tier</span>
            <span className="project-list-col project-list-col--date">Last Updated</span>
          </div>
