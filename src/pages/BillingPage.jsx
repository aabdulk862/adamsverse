...
function PaymentForm({ invoice, onSuccess, onCancel }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (fnError || !data?.client_secret) {
        setError(fnError?.message || 'Failed to create payment. Please try again.')
        setProcessing(false)
        return
      }
  ...
  return (
    <div className="billing-payment-modal" role="dialog" aria-label="Payment form">
    ...
    <div className="billing-page">
      ...
      {loading ? (
        ...
        <div className="billing-empty">
          ...
          <p>Invoices will appear here once they're created for your projects.</p>
        </div>
      ) : (
