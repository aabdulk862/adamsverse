    ...
    <div className="messages-page">
      ...
      {loading ? (
        ...
        <div className="dashboard-empty-state">
          ...
          <p>Messages from your projects will show up here. Start a project to begin a conversation.</p>
            ...
            >
              <div className="messages-thread-icon">
                ...
                {thread.unreadCount > 0 && (
                  <span className="messages-thread-badge" aria-label={`${thread.unreadCount} unread`}>
              ...
              <div className="messages-thread-content">
                <div className="messages-thread-header">
                  <span className="messages-thread-name">{thread.projectName}</span>
                  <span className="messages-thread-time">{formatTime(thread.lastMessageAt)}</span>
                </div>
                <p className={`messages-thread-preview${thread.unreadCount > 0 ? ' messages-thread-preview--unread' : ''}`}>
