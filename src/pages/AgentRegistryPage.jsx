...
export default function AgentRegistryPage() {
  ...
  if (isLoading) {
    return (
      <div role="status" aria-label="Loading agent roles" style={{ padding: '2rem', textAlign: 'center' }}>
  ...
  return (
    <div style={{ padding: '1.5rem' }}>
      ...
      {roles.length === 0 ? (
        <div role="status" aria-label="Empty agent registry" style={{ padding: '2rem', textAlign: 'center', color: '#888' }}>
